...
class LibraryPreferences(
    ...
    val filterChapterBySubChapter: Preference<Long> = preferenceStore.getLong(
        "default_chapter_filter_by_sub_chapter",
        Manga.SHOW_ALL,
    )

    val filterChapterByExcluded: Preference<Long> = preferenceStore.getLong(
        "default_chapter_filter_by_excluded",
        Manga.CHAPTER_SHOW_NOT_EXCLUDED,
    )
    ...
    fun setChapterSettingsDefault(manga: Manga) {
        ...
        filterChapterByExcluded.set(manga.excludedFilterRaw)
