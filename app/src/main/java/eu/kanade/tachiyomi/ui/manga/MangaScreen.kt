...
class MangaScreen(
    ...
    override fun Content() {
        ...
        MangaScreen(
            ...
            onEditInfoClicked = viewModel::showEditMangaDialog.takeIf { successState.manga.favorite },
            ...
            onMultiHideClicked = viewModel::excludeChapters,
            onShowChapterInfo = viewModel::showChapterInfoDialog,
        ...
        when (val dialog = successState.dialog) {
            ...
            is MangaViewModel.Dialog.ChapterInfo -> {
                ChapterInfoDialog(
            ...
            MangaViewModel.Dialog.SettingsSheet -> ChapterSettingsDialog(
                ...
                onSubChapterFilterChanged = viewModel::setSubChapterFilter,
                onExcludedFilterChanged = viewModel::setExcludedFilter,
